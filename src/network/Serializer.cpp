...
const std::string Serializer::serialize(const GameplayMessage &message) {
  switch (message.messageType) {
    ...
    default:
      throw std::runtime_error("Serializer: Unknown / Unhandled message type " + message.messageType);
  }
};
